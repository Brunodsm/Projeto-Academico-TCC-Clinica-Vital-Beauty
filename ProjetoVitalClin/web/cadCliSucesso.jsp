<%-- 
    Document   : cadCliSucesso
    Created on : 29/05/2018, 13:53:41
    Author     : bruno
--%>
...
<body>
    ...
    <main class="conteudo-principal">
        <div class="container-main">
            ...
            <h1 class="titulo-form">O cliente foi cadastrado com sucesso!</h1>

                <div class="div-a">
                <a class="botao-a" href="CliCadastro.jsp">Cadastrar novo Cliente</a>
                <a class="botao-a" href="ControleCliente?acao=Listar">Ir para listar Cliente</a>
                <a class="botao-a" href="pedidoRealizar.html?id=1">Ir para agendamentos</a>
                 </div>
            </div>
