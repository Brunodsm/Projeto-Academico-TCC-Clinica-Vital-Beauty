<%-- 
    Document   : cliEditSucesso
    Created on : 29/05/2018, 14:21:50
    Author     : bruno
--%>
...
<head>
    ...
    <link rel="stylesheet" href="css/CliAlterSucess.css">
    <!-- Fontes  -->
...
<body>
    ...
    <main class="conteudo-principal">
        <div class="container-main">
            <div class="div-main">
            <img class="img" src="img/userEdit.png">
            <h1 class="titulo-form">Cliente Alterado com sucesso</h1>
