    ...
    <main class="container">
        <form class="formulario" action="ControleAutentica" method="POST">
            ...
            <fieldset class="field">
                ...
                <label for="email">
                    <input type="email" name="txtEmail" id="email" placeholder="email" autofocus>
                </label>

                <label for="password">
                    <input type="password" name="txtSenha" id="password" placeholder="senha">    
                </label>
        ...
        <form id="modal-recuperar_senha" class="modal" action="#" method="POST">               
