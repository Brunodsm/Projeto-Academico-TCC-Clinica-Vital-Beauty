...
public class ClienteDAO {
    ...
    private static final String SELECT_ALL = "SELECT c.*, u.email FROM cliente c, usuario u WHERE c.usuarioFK = u.id and c.situacao<>2;";
    private static final String BUSCAR_NOME = "SELECT c.*, u.email FROM cliente c, usuario u WHERE c.usuarioFK = u.id and nome=? and c.situacao<>2;";
    private static final String BUSCAR_CPF = "SELECT c.*, u.email FROM cliente c, usuario u WHERE c.usuarioFK = u.id and c.cpf=? and c.situacao<>2;";
    ...
    private static final String BUSCAR = "SELECT c.*, u.email FROM cliente c, usuario u WHERE c.usuarioFK = u.id and c.id=? and c.situacao<>2;";
